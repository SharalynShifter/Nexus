...
void Map::addMonster(int x, int y) {
    ...
    if (rng->getInt(0, 100) < 80) {
        ...
        troll->destructible = new MonsterDestructible(16, 1, "troll carcass",50);
...
void Map::render() const {
    ...
    dx = noise->get(&tdx) * 1.1f;
    tdx += 30.0f;
    dy = noise->get(&tdx) * 1.1f;
